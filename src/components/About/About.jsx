...
import aboutImage from '../../assets/About/delish-licks.png'; // Image for the about section
    ...
    return (
        <Box
            sx={{
                ...
                ml: { xs: 0, md: '320px' }, // No margin on mobile
                padding: { xs: '20px 10px', md: '40px 20px' }, // Reduced padding on mobile
                boxSizing: 'border-box',
                overflowX: 'hidden',
                minHeight: { xs: 'auto', md: '80vh' }, // Auto height on mobile
            }}
        >
            {/* Image Section */}
            <Box
            ...
            >
                <img
                    ...
                    style={{
                        width: '100%',
                        maxWidth: { xs: '300px', md: '400px' }, // Smaller on mobile
                        height: 'auto',
                        borderRadius: '10px', // Optional: Add a slight border radius
                    }}
                />
            </Box>
